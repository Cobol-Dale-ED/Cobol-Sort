      ...
      ********************************
            ...
            DISPLAY ' '                                               
            DISPLAY 'START TIME OF DALE  SORT ' WS-TIME-DISPLAY.     
            ...
            MOVE CORRESPONDING WS-TIME TO WS-TIME-DISPLAY.             
            DISPLAY ' '                                               
            DISPLAY 'END TIME OF DALE  SORT ' WS-TIME-DISPLAY.  
      ...
      *      Dale Sort
       SORT-STUDENTS.
      *		   MOVE 50 TO SORT-SIZE.
	   
           PERFORM VARYING I  FROM 1 BY 1 UNTIL I  > SORT-SIZE	   
           ADD 1 TO I GIVING J 
           PERFORM  UNTIL J > SORT-SIZE
      *		     DISPLAY SORT-VALUE (I) '  ' SORT-VALUE (J)
             IF SORT-VALUE(I) NOT < SORT-VALUE(J)
      ...
      *       display 'bump multiple times = 'K
          ...
          ELSE
             MOVE SORT-VALUE(I)   	TO SORT-TEMP
             MOVE SORT-VALUE(J)   	TO SORT-VALUE(I)
             MOVE SORT-TEMP 		TO SORT-VALUE(J)
          END-IF.

       BUMP-STUDENTS.
          MOVE SORT-VALUE(J)   		TO SORT-TEMP.
          MOVE J 					TO M.
          PERFORM K TIMES
             MOVE SORT-VALUE(M - 1) TO SORT-VALUE(M)
             SUBTRACT 1 FROM M
          END-PERFORM.
          MOVE SORT-TEMP 			TO SORT-VALUE(I).
